class GeneratorItem {
    ...
    generateValue() {
        ...
        if (this.blockName === 'snils1' || this.blockName === 'snils2') {
            ...
            if (this.blockName === 'snils2' && this.setValueCounter % 2 === 0 && localStorage.getItem(`requisiteGenerator_snils1`)) part = localStorage.getItem(`requisiteGenerator_snils1`).replaceAll(' ', '').replaceAll('-', '');
        }
